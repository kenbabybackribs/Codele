...
const pressKey = function(key) {
    ...
    if (activeTiles.length >= (0, _config.WORD_LENGTH)) return;
...
const submitGuess = function() {
    ...
    if (activeTiles.length !== (0, _config.WORD_LENGTH)) {
    ...
    if (!(0, _targetDefault.default).includes(guess)) {
...
const danceTiles = function(tiles) {
    tiles.forEach((tile, index)=>{
        ...
        }, index * (0, _config.DANCE_ANIMATION) / 5);
    });
};
const flipTiles = function(tile, index, array, guess) {
    ...
    tile.addEventListener("transitionend", ()=>{
        ...
        if (index === array.length - 1) tile.addEventListener("transitionend", ()=>{
            startInteraction();
...
parcelHelpers.export(exports, "FLIP_DURATION", ()=>FLIP_DURATION);
parcelHelpers.export(exports, "DANCE_ANIMATION", ()=>DANCE_ANIMATION);
const WORD_LENGTH = 5;
const FLIP_DURATION = 500;
const DANCE_ANIMATION = 500;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["farZc","8lqZg"], "8lqZg", "parcelRequire521c")
